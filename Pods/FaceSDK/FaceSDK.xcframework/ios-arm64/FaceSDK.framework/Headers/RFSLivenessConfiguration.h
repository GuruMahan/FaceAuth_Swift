...
/// Defines session ID that can be used in Liveness processing. Defaults to `nil`.
@property(readonly, nonatomic, strong, nullable) NSString *sessionId;
...
/// @see RFSLivenessConfiguration.sessionId.
@property(readwrite, nonatomic, strong, nullable) NSString *sessionId;
